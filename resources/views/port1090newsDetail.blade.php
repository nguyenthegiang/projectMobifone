...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Port 1090 News Detail</title>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-10">
									<div id="titleButton">
											<span class="label label-xl label-primary label-pill label-inline mr-2 font-weight-bold w-200px h-50px"
								...
								<div class="row">
									...
									<div class="col-10">
										<div class="row">
											<h2 style="font-weight: bold;">{{$news->title}}</h2>
										</div>

										<div class="row">
											<div class="col-4">
												<img src="{{asset('images')}}/{{$news->image}}" alt="{{$news->title}}" style="width: 200px;">
											</div>

											<div class="col-8">
												<span><?php echo $news->shortContent ?></span>
											</div>
										</div>
								...
								<div class="row">
									...
									<div class="col-10">
										<div class="row">
											<button type="button" class="btn btn-primary detailButton">Hỏi đáp</button>
											<button type="button" class="btn btn-success btn-shadow-hover detailButton" onclick="showRelatedNews()">Tin liên quan</button>
											<button type="button" class="btn btn-success btn-shadow-hover detailButton" onclick="showDocumentary()">Công văn</button>
											<button type="button" class="btn btn-primary detailButton">Thông báo</button>
											<button type="button" class="btn btn-primary detailButton">Khuyến mại</button>
										</div>

										<div class="row" id="relatedNews" style="display: none;">
											@foreach($otherNews as $Onews)
											<section>
												<a href="http://localhost:8000/port1090news/{{$Onews->id}}" id="cardLink">
													<div class="card mb-3 card1090">
														<div class="font-size-h4 font-weight-bolder">{{$Onews->title}}</div>
														<div class="row no-gutters">
															<div class="col-md-2">
																<img src="{{asset('images')}}/{{$Onews->image}}" alt="{{$Onews->name}}" width="100px">
															</div>
															<div class="col-md-10">
																<div class="card-body">
																	<p class="card-text"><?php echo $Onews->shortContent ?></p>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="row" id="documentary1" style="display: none;">
											<table class="table table-bordered table-primary">
												...
												<tbody>
													...
													<tr>
														<th scope="row">
															<a href="{{asset('files')}}/{{$documentary->fileLink}}">{{$documentary->code}}</a>
														</th>
														<td>{{$documentary->title}}</td>
														<td>{{$documentary->applyTime}}</td>
														<td>{{$documentary->content}}</td>
														<td>{{$documentary->region}}</td>
														<td>{{$documentary->updated_at}}</td>
													</tr>
													@endforeach
												</tbody>
											</table>
							...
							<script>
								function showRelatedNews() {
									var x = document.getElementById("relatedNews");
									var y = document.getElementById("documentary1");
								...
								function showDocumentary() {
									var x = document.getElementById("documentary1");
									var y = document.getElementById("relatedNews");
									if (x.style.display === "none") {
										x.style.display = "block";
										y.style.display = "none";
									} else {
