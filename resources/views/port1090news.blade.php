								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="/port1090news">Quản lý tin tức</a>
											</li>
											<li class="nav-item">
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-10">
										...
										<button id="otherTitleButton" class="btn btn-outline-primary btn-pill font-weight-bold">
											Hiển thị 50 bản tin&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-down"></i>
										</button>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-2">
										<a href="port1090news/create" type="button" class="btn btn-lg btn-block btn-shadow-hover btn-success font-weight-bold text-uppercase">
											Tạo tin mới
										</a>
										<hr>
										<a href="port1090documentary" type="button" class="btn btn-lg btn-block btn-shadow-hover btn-info">
											Quản lý công văn
										</a>
									</div>
									...
									<div class="col-10">
										<table>
											...
											<tr>
												<td>
													<section>
														<a href="port1090news/{{$news->id}}" id="cardLink">
															<div class="card mb-3 card1090">
																<div class="font-size-h4 font-weight-bolder">{{$news->title}}</div>
																<br>
																<div class="row no-gutters">
																	<div class="col-md-2">
																		<img src="{{asset('images')}}/{{$news->image}}" alt="{{$news->name}}" width="100px">
																	</div>
																	<div class="col-md-10">
																		<div class="card-body">
																			<p class="card-text"><?php echo $news->shortContent ?></p>
																		</div>
																	</div>
																</div>
															</div>
												...
												<td>
													<section>
														<div class="card mb-3 card1090">
															<a href="port1090news/{{$news->id}}/edit" class="btn btn-warning btn-block btn-lg btn-shadow-hover font-weight-bold text-uppercase">
																Sửa
															</a>
															<br>
															<form action="port1090news/{{$news->id}}" method="POST">
																@csrf
																@method('DELETE')
																<input type="submit" value="Xóa" class="btn btn-danger btn-block btn-lg btn-shadow-hover font-weight-bold text-uppercase">
															</form>
														</div>
													</section>
												</td>
