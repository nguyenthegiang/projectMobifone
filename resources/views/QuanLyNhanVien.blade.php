...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script>    
    		var myTree = {!! json_encode($myTree->toArray(), JSON_HEX_TAG) !!};
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<!--begin::Row-->
                                    ...
                                    <!--[{Mine}] begin::Màn hình quản lý nhân viên -->
                                        <div class="row">
                                            <div class="col-xxl-12 order-1 order-xxl-2">
                                                <!--begin::List Widget 3-->
                                                <div class="card card-custom card-stretch gutter-b">
                                                    <p style="margin: 10px;">Chỉ hiển thị nhân viên đang còn làm việc</p> 
                                                    ...
                                                    <div class="col-4">
                                                        <div class="row">
                                                        <div class="col-3">
                                                            <h6 style="margin: 15px 0 0 20px;">Quản lý KD Tỉnh</h6>
                                                        </div>
                                                        <div class="col-9">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td>1/1/1993</td>
                                                            <td>9/1/2021</td>
                                                            <td><a type="button" class="btn btn-warning btn-sm">Sửa</a></td>
                                                            <td><a type="button" class="btn btn-danger btn-sm">Xóa</a></td>
                                                            </tr>
                                                            <tr>
                                                            <th scope="row">Nguyễn Văn A</th>
                                                            <td>C4_xxx</td>
                                                        ...
                                                        <br>
                                                        <a type="button" class="btn btn-success" style="float: right; margin-right: 10px;">Tạo mới</a>
                                                    </div>
                                                    <!--end::Right-->
                                                    </div>
                                                    ...
                                                    <p style="margin: 10px;">Thêm sửa xóa nhân viên (quản lý tỉnh có thể thêm sửa xóa toàn bộ, cấp huyện thì chỉ thêm sủa xóa ở huyện)</p> 
                                                </div>
                                                <!--end: List Widget 3-->
                                            </div>
                                        </div>
                                    <!--[{Mine}] end::Màn hình quản lý nhân viên-->
        ...
        <!--begin::Page Vendors(used by this page)-->
		<script src="assets/plugins/custom/jstree/jstree.bundle.js?v=7.0.5"></script>
		<!--end::Page Vendors-->
		
        <!--[{Mine}] begin::Script cho TreeView -->
        <script src="assets/js/QuanLyNhanVienScript.js"></script>
        <!--[{Mine}] end::Script cho TreeView -->
	</body>
	<!--end::Body-->
</html>