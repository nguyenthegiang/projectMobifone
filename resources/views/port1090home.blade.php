								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="/port1090home">Cổng 1090</a>
											</li>
											<li class="nav-item">
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-10">
										...
										<a href="port1090news" id="showAllButton" type="button" class="btn btn-outline-primary btn-pill font-weight-bold">
											Xem tất cả
										</a>
									</div>
								</div>
								...
								<div class="row">
									...
									<!-- Left Column -->
									<div class="col-5">
										<a href="port1090news/{{$news1->id}}" id="cardLink">
											<div class="card" style="width: 35rem;">
												<img src="{{asset('images')}}/{{$news1->image}}" class="card-img-top" alt="{{$news1->title}}">
												<div class="card-body">
													<h5 class="card-title cardTitle1090Home">{{$news1->title}}</h5>
													<p class="card-text"><?php echo $news1->shortContent ?></p>
												</div>
											</div>
										</a>
									</div>
									...
									<!-- Right Column -->
									<div class="col-5">
										@for ($i = 1; $i < 5; $i++) <a href="port1090news/{{$_4news[$i]->id}}" id="cardLink">
											<div class="card mb-3" style="max-width: 540px;">
												<div class="row no-gutters">
													<div class="col-md-4">
														<img src="{{asset('images')}}/{{$_4news[$i]->image}}" alt="{{$_4news[$i]->title}}" style="width: 160px;">
													</div>
													<div class="col-md-8">
														<div class="card-body">
															<h5 class="card-title cardTitle1090Home">{{$_4news[$i]->title}}</h5>
															<p class="card-text"><?php echo substr($_4news[$i]->shortContent, 0, 400) ?></p>
														</div>
													</div>
												</div>
											</div>
