				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="/port1090documentary">Quản lý công văn</a>
											</li>
										</ul>
										<!-- {[Mine]} end:: Nav-bar -->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								<div class="row">
									<a href="port1090documentary/create" class="btn btn-light-success font-weight-bold mr-2 btn-lg">Tạo công văn mới</a>
								</div>
								<br>
								...
								<div class="row">
									<table class="table table-bordered table-primary">
										...
										<tbody>
											...
											<tr>
												<th scope="row">{{$documentary->code}}</th>
												...
												<td>{{$documentary->port1090_news->title}}</td>
												<td><a href="{{asset('files')}}/{{$documentary->fileLink}}">{{$documentary->fileLink}}</a></td>
												<td>
													<a href="port1090documentary/{{$documentary->id}}/edit" class="btn btn-light-warning font-weight-bold mr-2 btn-lg">Sửa</a>
												</td>
												<td>
													<form action="port1090documentary/{{$documentary->id}}" method="POST">
														@csrf
														@method('DELETE')
														<input type="submit" value="Xóa" class="btn btn-light-danger font-weight-bold mr-2 btn-lg">
													</form>
												</td>
											</tr>
											@endforeach
