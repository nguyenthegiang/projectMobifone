					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<!--[{Mine}] begin::Link đến màn hình tra cứu -->
								...
								<!--[{Mine}] end::Link đến màn hình tra cứu -->

                                <!--[{Mine}] begin::Link đến màn hình quản lý nhân viên -->
								<li class="menu-item menu-item-active" aria-haspopup="true">
								...
								<!--[{Mine}] end::Link đến màn hình quản lý nhân viên -->

								<!--[{Mine}] begin::Link đến màn hình Báo cáo -->
								<li class="menu-item menu-item-active" aria-haspopup="true">
								...
								<!--[{Mine}] end::Link đến màn hình Báo cáo -->

								<!--[{Mine}] begin::Link đến màn hình Port 1090 -->
								<li class="menu-item menu-item-active" aria-haspopup="true">
								...
								<!--[{Mine}] end::Link đến màn hình Port 1090 -->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<!--[{Mine}] begin::Màn hình hiển thị tra cứu -->
                                    <div class="row">
                                        <div class="col-xxl-9">
                                            <!--begin::Mixed Widget 1-->
                                                <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                                    <a class="btn btn-success btn-shadow font-weight-bold mr-2" style="font-size: x-large;">
                                                        Tra cứu số thuê bao
                                                    </a>
                                                    <br/>
                                                        ...
                                                        <form class="form">
                                                         <div class="card-body">
                                                          <div class="form-group" style="display: inline;">
                                                           <label style="display: inline; padding-right: 230px; font-size: medium;">Nhập số</label>
                                                           <input type="text" class="form-control form-control-solid" placeholder="Ví dụ 9xxxxx" style="width: 240px; display: inline;"/>
                                                          </div>
                                                          <button type="submit" class="btn btn-warning mr-2 btn-shadow-hover btn-pill" style="display: inline; float: right;">Tra cứu</button>
                                                         </div>
                                                        </form>
                                                        <!--end::Form-->
                                                    </div>
                                                    ...
                                                    <h2 style="margin: 5px;"><span class="badge badge-pill badge-warning">Thông tin thuê bao</span></h2>
                                                    <br>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <td style="text-align: center;">Bùi Văn Quỳnh</td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="2">Gói hiện tại</td>
                                                        <td style="text-align: center;">...</td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="2">Lịch sử gói đăng ký</td>
                                                        <td style="text-align: center;"></td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="2">Xã Online gần nhất</td>
                                                        <td style="text-align: center;"></td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="2">Lưu lượng data 3 tháng gần nhất</td>
                                                        <td style="text-align: center;">50MB</td>
                                                        </tr>
                                                        <tr>
                                                        <td rowspan="2">Lưu lượng thoại</td>
                                                        <td>Ngoại mạng</td>
                                                        ...
                                                        <tr>
                                                        <td colspan="2">Arpu bình quân</td>
                                                        <td style="text-align: center;"></td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="2">Arpu bình quân</td>
                                                        ...
                                                        <td>Gói cước có thể tư vấn đăng ký</td>
                                                        <td colspan="2"></td>
                                                        </tr>
                                                    </table>
                                                    </div>
                                                    ...
                                                    <span style="margin-left:100px;">
                                                        Chỉ hiển thị thông tin thuê bao của nhân viên phát triển và đang hoạt động
                                                    </span>
                                                    </div>
                                                </div>
                                            <!--end::Mixed Widget 1-->
                                        ...
                                        <div class="col-xxl-3 order-1 order-xxl-1">
                                            <!--begin::List Widget 1-->
                                ...
                                <!--[{Mine}] end::Màn hình hiển thị tra cứu -->
