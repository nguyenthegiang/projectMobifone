							...
							<div class="container">
								<div class="row justify-content-center">
									<div class="col-md-8">
										...
										<h1><span class="badge rounded-pill bg-warning">Edit 1090 News</span></h1>

										<hr>

										<form action="/port1090news/{{$news->id}}" method="POST" enctype="multipart/form-data">
											@csrf
											@method('PUT')
											<div class="form-group">
												<label for="newsTitle" class="required-field">News Title</label>
												<input type="text" name="title" class="form-control" placeholder="Title..." id="newsTitle" value="{{$news->title}}">
											</div>

											<div class="form-group">
												<label for="newsContent" class="required-field">Short Content</label>
												<textarea class="form-control newsContent" rows="5" name="shortContent" placeholder="Short Content...">{{$news->shortContent}}</textarea>
											</div>

											<div class="form-group">
												<label for="newsContent" class="required-field">Full Content</label>
												<textarea class="form-control newsContent" rows="15" name="content" placeholder="Content...">{{$news->content}}</textarea>
											</div>

											<label for="NewsImage" class="required-field">News Image</label>
											...
											<button class="btn btn-warning btn-shadow-hover font-weight-bold btn-lg" type="submit">Update</button>
										</form>
									</div>
								</div>
							</div>

							<script src="https://cdn.tiny.cloud/1/oirjc896irmt1z8y4pk4uj3v6ycbmka80tjbhb4ti0k1rmfd/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
