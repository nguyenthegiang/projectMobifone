...
<html lang="en">
	...
	<head><base href="../../">
		...
		<link href="{{ asset('css/custom.css') }}" rel="stylesheet">	<!--Link đến File CSS của mình-->
	</head>
	<!--end::Head-->
	<!--begin::Body-->
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
										...
										<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link" href="/port1090home">Cổng 1090</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="/port1090news">Quản lý tin tức</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="/port1090documentary">Quản lý công văn</a>
											</li>
										</ul>
										<!-- {[Mine]} end:: Nav-bar -->
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container : Code bắt đầu từ đây-->
							<div class="container">
								<div class="row justify-content-center">
									<div class="col-md-8">
										...
										<h1><span class="badge rounded-pill bg-warning">Sửa Công Văn</span></h1>

										<hr>

										<form action="/port1090documentary/{{$documentary->id}}" method="POST" enctype="multipart/form-data">
											@csrf
											@method('PUT')
											<div class="form-group">
												<label for="code" class="required-field">Số công văn</label>
												<input type="text" name="code" class="form-control" placeholder="Số công văn..." id="code" value="{{$documentary->code}}">
											</div>

											<div class="form-group">
												<label for="title" class="required-field">Tiêu đề</label>
												<textarea class="form-control" id="title" rows="10" name="title" placeholder="Tiêu đề..."><?php echo $documentary->title ?></textarea>
											</div>

											<div class="form-group">
												<label for="applyTime" class="required-field">Thời gian áp dụng</label>
												<input type="date" name="applyTime" class="form-control" id="applyTime" value="<?php $date = strtotime($documentary->applyTime); $newformat = date('Y-m-d', $date); echo $newformat; ?>">
											</div>

											<div class="form-group">
												<label for="content" class="required-field">Nội dung</label>
												<textarea class="form-control" id="content" rows="10" name="content" placeholder="Nội dung..."><?php echo $documentary->content ?></textarea>
											</div>

											<div class="form-group">
												<label for="region" class="required-field">Khu vực</label>
												<textarea class="form-control" id="region" rows="5" name="region" placeholder="Khu vực..."><?php echo $documentary->region ?></textarea>
											</div>

											<div class="form-group">
												<label for="newses" class="required-field">Tin tức</label>
												<select class="form-control" name="newsId" id="newses">
													@foreach($newses as $news)
														<option value="{{$news->id}}" {{$documentary->port1090_news_id === $news->id ? 'selected' : ''}}>{{$news->title}}</option>
													@endforeach
												</select>
											</div>

											<label for="inputGroupFile01" class="required-field">File</label>
											<div class="input-group mb-3">
												<div class="input-group-prepend">
													<span class="input-group-text">Upload</span>
												</div>
												<div class="custom-file">
													<input type="file" name="fileLink" class="custom-file-input" id="inputGroupFile01">
													<label class="custom-file-label" for="inputGroupFile01">Choose File</label>
												</div>
											</div>

											<button class="btn btn-light-warning font-weight-bold mr-2 btn-lg" type="submit">Save</button>
										</form>
									</div>
								</div>
							</div>
							<!--end::Container : Code kết thúc ở đây-->
						</div>
						<!--end::Entry-->
					</div>
					<!--end::Content-->
