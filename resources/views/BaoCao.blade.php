...
<html lang="en">
	...
	<head><base href="../../">
		...
		<link href="assets/css/BaoCaoStyle.css" rel="stylesheet" type="text/css" />	<!--Link đến File CSS của mình-->
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<!-- begin::Link đến các màn hình -->
								<li class="menu-item" aria-haspopup="true">
									<a href="/hienThi" class="menu-link">
										<i class="menu-icon flaticon-home"></i>
										<span class="menu-text">Màn hình hiển thị tra cứu</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="/quanLy" class="menu-link">
										<i class="menu-icon flaticon-home"></i>
										<span class="menu-text">Màn hình quản lý nhân viên</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="/baoCao" class="menu-link">
										<i class="menu-icon flaticon-home"></i>
										<span class="menu-text">Màn hình Báo cáo</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="/port1090home" class="menu-link">
										<i class="menu-icon flaticon-home"></i>
										<span class="menu-text">Port 1090</span>
									</a>
								</li>
								<!-- end::Link đến các màn hình -->
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Hiển Thị Báo Cáo</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container-->
							<div class="container">
								<!-- begin::Code bắt đầu từ đây -->
								<div class="row">
									<!-- begin::Component 1: Form -->
									<div class="card card-custom gutter-b myComponent">
										<!-- Card Title -->
										<div class="card-header ribbon ribbon-clip ribbon-left">
											<div class="ribbon-target" style="top: 12px;">
												<span class="ribbon-inner bg-primary"></span>	<span class="myFormHeader">Điều kiện báo cáo</span>
											</div>
										...
										<div class="card-body">
											<!-- Form Body -->
											<form action="/baoCao" method="POST" enctype="multipart/form-data">
											<!-- Submit sang method store() trong BaoCaoController -->
											@csrf
												<div class="form-group row">
													<div class="col-6">
														<div class="row">
															<label class="col-form-label text-right col-lg-3 col-sm-12 required-field">Cửa hàng</label>
															<div class=" col-lg-4 col-md-9 col-sm-12">
															<select class="form-control select2" id="kt_select2_1" name="store">
													...
													<div class="col-6">
														<div class="row">
															<label class="col-form-label text-right col-lg-3 col-sm-12">Lý do</label>
															<div class=" col-lg-4 col-md-9 col-sm-12">
															<select class="form-control select2" id="kt_select2_2" name="reason">
															@foreach($reasons as $reason) 
																<option 
																value="{{$reason->id}}"
																@isset($selectedReason)
												...
												<div class="form-group row">
													<div class="col-6">
														<div class="row">
															<label class="col-form-label text-right col-lg-3 col-sm-12">Loại doanh thu</label>
															<div class=" col-lg-4 col-md-9 col-sm-12">
															<select class="form-control select2" id="kt_select2_3" name="revenueType">
															@foreach($revenueTypes as $revenueType) 
																<option 
																value="{{$revenueType->id}}"
																@isset($selectedRevenueType)
																@if ($selectedRevenueType == $revenueType->id)
																selected="selected"
																@endif
																@endisset
																>{{$revenueType->revenueType_name}}</option>
															@endforeach
															</select>
															</div>
														</div>
													...
													<div class="col-6">
														<div class="row">
															<label class="col-form-label text-right col-lg-3 col-sm-12">Loại báo cáo</label>
															<div class=" col-lg-4 col-md-9 col-sm-12">
															<select class="form-control select2" id="kt_select2_4" name="reportType">
															@foreach($reportTypes as $reportType) 
																<option 
																value="{{$reportType->id}}"
																@isset($selectedReportType)
																@if ($selectedReportType == $reportType->id)
																selected="selected"
																@endif
																@endisset
																>{{$reportType->reportType_name}}</option>
															@endforeach
															</select>
															</div>
														</div>
												...
												<div class="form-group row">
													<label class="col-form-label text-right col-lg-3 col-sm-12 required-field">Ngày</label>
													<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-daterange input-group" id="kt_datepicker_5">
														<input type="text" class="form-control" name="dateStart"
														@isset($selectedDateStart)
														...
														@isset($selectedDateEnd)
														value="{{$selectedDateEnd}}"
														@endisset
														/>
													</div>
													<span class="form-text text-muted">Chọn từ ngày bao nhiêu đến ngày bao nhiêu</span>
													</div>
												</div>
												...
												<div class="container">
													<div class="row">
														<div class="col-6">
															<!-- Link đến File Báo Cáo -->
														@if (file_exists(public_path('assets/BaoCao.pdf')))
															<span class="label label-xl label-pill label-inline font-weight-bold mr-2">
																<a href="assets/BaoCao.pdf" id="myPdfLink">BaoCao.pdf</a>
															</span>
														@endif
														</div>

														<div class="col-6">
															<button name="action" value="excel" type="submit" class="btn btn-light-info font-weight-bold mr-2 myToTheRight">
																Xuất file EXCEL (.xls) <i class="far fa-file-excel"></i>
															</button>

															<button name="action" value="pdf" type="submit" class="btn btn-light-success font-weight-bold mr-2 myToTheRight">
																Xem <i class="fas fa-search"></i>
															</button>
														</div>
													</div>
												</div>
									...
									<!-- end::Component 1: Form -->

									<!-- begin::Component 2: Show Kết quả -->
									<div class="card card-custom gutter-b myComponent">
										<!-- Card Title -->
										<div class="card-header ribbon ribbon-clip ribbon-left">
											<div class="ribbon-target" style="top: 12px;">
												<span class="ribbon-inner bg-success"></span>	<span class="myFormHeader">Kết quả báo cáo</span>
											</div>
											<div class="card-title">
											 	<!-- <h3 class="card-label">
											  		Kết quả báo cáo
										...
										<!-- Nếu có tồn tại File -->
										@if (file_exists(public_path('assets/BaoCao.pdf')))
											<!-- Link đến File Báo cáo trong public/assets -->
											<iframe src="assets/BaoCao.pdf" width="100%" height="600px"></iframe>
										@endif
										</div>
									</div>
									<!-- end::Component 2: Show Kết quả -->
									
								</div>
								<!-- begin::Code kết thúc ở đây -->
		...
		<!--[{Mine}] begin::Script -->
        <script src="assets/js/BaoCaoScript.js"></script>
      <!--[{Mine}] end::Script -->
	</body>
	<!--end::Body-->
</html>