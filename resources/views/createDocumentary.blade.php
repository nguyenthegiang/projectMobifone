...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Create Documentary</title>
							...
							<div class="container">
								<div class="row justify-content-center">
									<div class="col-md-8">
										...
										<h1><span class="badge rounded-pill bg-success">Tạo Công Văn</span></h1>

										<hr>

										<form action="/port1090documentary" method="POST" enctype="multipart/form-data">
											@csrf
											<div class="form-group">
												<label for="code" class="required-field">Số công văn</label>
												<input type="text" name="code" class="form-control" placeholder="Số công văn..." id="code">
											</div>

											<div class="form-group">
												<label for="title" class="required-field">Tiêu đề</label>
												<textarea class="form-control" id="title" rows="10" name="title" placeholder="Tiêu đề..."></textarea>
											</div>

											<div class="form-group">
												<label for="applyTime" class="required-field">Thời gian áp dụng</label>
												<input type="date" name="applyTime" class="form-control" id="applyTime">
											</div>

											<div class="form-group">
												<label for="content" class="required-field">Nội dung</label>
												<textarea class="form-control" id="content" rows="10" name="content" placeholder="Nội dung..."></textarea>
											</div>

											<div class="form-group">
												<label for="region" class="required-field">Khu vực</label>
												<textarea class="form-control" id="region" rows="5" name="region" placeholder="Khu vực..."></textarea>
											</div>
											...
											<button class="btn btn-light-success font-weight-bold mr-2 btn-lg" type="submit">Save</button>
										</form>
									</div>
								</div>
							</div>
