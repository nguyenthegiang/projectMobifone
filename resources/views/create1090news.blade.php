							...
							<div class="container">
								<div class="row justify-content-center">
									<div class="col-md-8">
										...
										<h1><span class="badge rounded-pill bg-success">Create 1090 News</span></h1>

										<hr>

										<form action="/port1090news" method="POST" enctype="multipart/form-data">
											@csrf
											<div class="form-group">
												<label for="newsTitle" class="required-field">News Title</label>
												<input type="text" name="title" class="form-control" placeholder="Title..." id="newsTitle">
											</div>

											<div class="form-group">
												<label for="newsContent" class="required-field">Short Content</label>
												<textarea class="form-control newsContent" rows="5" name="shortContent" placeholder="Short Content..."></textarea>
											</div>

											<div class="form-group">
												<label for="newsContent" class="required-field">Full Content</label>
												<textarea class="form-control newsContent" rows="15" name="content" placeholder="Content..."></textarea>
											</div>
											...
											<button class="btn btn-success btn-shadow-hover font-weight-bold btn-lg" type="submit">Save</button>
										</form>
									</div>
								</div>
							</div>
